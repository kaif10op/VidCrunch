        ...
        >
          {currentTab === "chapters" ? (
             <div className="space-y-12">
               {timestamps && timestamps.length > 0 ? timestamps.map((ts, i) => (
                  ...
                  <div className="flex flex-col items-center justify-center py-16 text-center">
                    ...
                    <h3 className="text-lg font-bold text-foreground mb-2">Chapters Generating</h3>
                    <p className="text-sm text-muted-foreground max-w-sm">
                      Chapter markers are being generated by AI. Try refreshing the page in a moment, or switch to the Transcript tab.
                    </p>
                  </div>
               )}
                 </div>
