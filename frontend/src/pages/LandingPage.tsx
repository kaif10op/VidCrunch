    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans selection:bg-black selection:text-white">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 bg-white/80 backdrop-blur-md border-b border-gray-100 h-16 flex items-center justify-between px-6 lg:px-12">
        ...
        <div>
          {isAuthenticated ? (
            <Link to="/dashboard">
              <Button className="rounded-2xl gap-2 bg-black text-white hover:bg-gray-900 font-bold">
      ...
      <section className="pt-32 pb-20 px-6 lg:px-12 max-w-7xl mx-auto flex flex-col items-center text-center">
        ...
        >
          ...
          <span className="text-xs font-bold uppercase tracking-widest text-gray-500">Now with AI Roadmap Generation</span>
        </motion.div>
        ...
        >
          Master any <span className="text-gray-400">video</span> in minutes.
        </motion.h1>
        ...
        >
          {isAuthenticated ? (
            <Link to="/dashboard">
              <Button size="lg" className="rounded-2xl h-14 px-8 bg-black text-white hover:bg-gray-900 text-base font-bold gap-2 shadow-xl shadow-black/10">
          ...
          <Button variant="outline" size="lg" className="rounded-2xl h-14 px-8 border-gray-200 text-base font-bold">
            Watch Demo
          </Button>
        </motion.div>
        ...
        <motion.div 
          ...
          className="mt-20 w-full max-w-5xl aspect-video bg-gray-50 rounded-[40px] border border-gray-100 shadow-2xl overflow-hidden relative group"
        >
          <div className="absolute inset-0 bg-gradient-to-br from-black/[0.02] to-transparent" />
          <div className="absolute inset-0 flex items-center justify-center">
             <div className="w-20 h-20 bg-white rounded-full shadow-2xl flex items-center justify-center group-hover:scale-110 transition-transform duration-500">
               <Play className="h-8 w-8 text-black ml-1" />
             </div>
          </div>
          {/* Decorative elements */}
          <div className="absolute top-8 left-8 w-64 h-32 bg-white/80 backdrop-blur rounded-2xl shadow-xl border border-white/50 p-4 text-left">
             <div className="w-8 h-2 bg-gray-100 rounded mb-3" />
             <div className="w-full h-2 bg-gray-50 rounded mb-2" />
             <div className="w-4/5 h-2 bg-gray-50 rounded " />
          </div>
          <div className="absolute bottom-8 right-8 w-48 h-48 bg-white/80 backdrop-blur rounded-[32px] shadow-xl border border-white/50 p-6 flex flex-col justify-between">
             <div className="w-12 h-12 bg-black rounded-2xl flex items-center justify-center">
               <Zap className="h-6 w-6 text-white" />
             </div>
             <div className="text-left">
               <div className="text-2xl font-black text-black">98%</div>
               <div className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Efficiency GAIN</div>
             </div>
          </div>
        </motion.div>
      </section>
      ...
      <section id="features" className="py-24 px-6 lg:px-12 bg-gray-50/50">
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-gray-500">Advanced AI tools built for serious learners.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {[
              ...
              <div key={i} className="p-8 bg-white rounded-[32px] border border-gray-100 hover:border-black/10 hover:shadow-xl transition-all group">
